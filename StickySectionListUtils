        ...
        while (i < index) {
            switch (elementPointer.type) {
                ...
                case "ROW": {
                    ...
                    const value = isData.photo === null && isData.hasOwnProperty('description') === false ? 60
                    : isData.photo === null && isData?.description?.length <= 40 ? 60
                        : isData.photo === null && isData?.description?.length > 14 ? 110
                          
                            : isData.photo !== null && isData?.description?.length >= 60 ? 120
                                : isData.photo !== null && isData.hasOwnProperty('description') === false ? 90
                                    : isData.photo !== null && isData.hasOwnProperty('description') === true ? 100
                                        : 100
